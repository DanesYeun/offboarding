            ...
            <div class="border bg-white w-75 h-75 rounded row m-0 d-flex justify-content-center">
                <div class="my-2 col-12">
                    ...
                    {{-- <form action="{{ route('request.generate.coe', ['id' => 'selected_id']) }}" method="POST" id="certificateForm" target="_blank"> --}}
                        <form action="{{ route('request.upload.coe') }}" method="POST" id="certificateForm" enctype="multipart/form-data">
                        ...
                        <div class="row m-0">
                            ...
                            <x-select name="request_id" label="Employee Name" :options="$options" required="true" mdSize="6"/>
                            <x-input name="coe_file" label="Upload COE" type="file" mdSize="6" required="true" />
                            <div class="col-12 mt-3">
                                <button type="submit" class="btn btn-lg btn-success">
                                    <i class="bi bi-save-fill p-2"></i>
                                    Save Certificate
                                </button>
                            </div>
